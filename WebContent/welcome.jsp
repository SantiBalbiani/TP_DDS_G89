	...
	<section class="jumbotron jumbotron-kd">
		<div class="container">
			...
			<div class="row">
			  	...
			  	<div class="col-sm-4"><a class="btn btn-default" href="crearIngrediente.jsp" role="button" id="nuevaReceta" data-toggle="tooltip" title="Crear una nueva receta" data-placement="bottom">
